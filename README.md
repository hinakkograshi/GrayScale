...
このプロジェクトは、**Swift for WebAssembly (SwiftWasm)** とJavaScriptのグレースケール処理のパフォーマンスを比較するために作成したWebアプリケーションのサンプルです。
...
Webブラウザで表示されたアドレスにアクセスし、「GrayScale」アプリケーションが正しく動作していることを確認してください。
